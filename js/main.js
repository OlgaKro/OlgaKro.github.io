...
//sv_settings
var selector='#content, #content *, .navbar, .navbar *, .nav, .nav*, .container,  .container *, body, #pricetable, .price-line-text, .price-header-text, .header-section, .subtitle, #team, p, h4, #contact, #home, .feature-item,.div_table,.div_header,footer,#main-nav, .navigation li a, .wc-text-box-1, h3, h5';
    //-------------
    $('.fs-outer button').click(function(){
        $(selector).css('font-size',$(this).css('font-size'));
	fontSizeCfg = $(this).attr('id');       
    ...
    $('.img-outer button').click(function(){
        if (imgCfg!='on'){
	    $('#companyPhotos').css('display','none');
        ...
        {
	    $('#companyPhotos').css('display','block');
...
if (svOnCfg==true){
	...
	$('#companyPhotos').css('height',height);

	$('#companyPhotos').backstretch([
		"images/bg_images4.jpg",
		"images/bg_images5.jpg",
